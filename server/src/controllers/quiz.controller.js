...
const updatePollOptionImpression = async (req, res) => {
    ...
    return res.status(200).json(
        new ApiResponse(200, data, "Poll option impression updated successfully")
    )
...
const getAllQuizzes = async (req, res) => {
    ...
    .status(200)
    .json(
        new ApiResponse(200, allQuizzes, "Trending quizzes fetched successfully")
    )
}
...
const getTrendingQuizzes = async (req, res) => {
    ...
    .status(200)
    .json(
        new ApiResponse(200, trendingQuizzes, "Trending quizzes fetched successfully")
    )
}
...
const getDashboardStats = async (req, res) => {
    ...
    .status(200)
    .json(
        new ApiResponse(200, {...totalQuizzesAndImpressions[0], ...totalQuestions[0]}, "Dashboard quiz status fetched successfully")
    )
}
